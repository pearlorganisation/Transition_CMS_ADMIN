    ...
    return (
        <div className="relative overflow-x-auto p-6 bg-gray-100 min-h-screen">
            <div className='flex justify-between items-center bg-white shadow-md p-4 rounded-md mb-6'>
                <h1 className='font-bold text-2xl text-gray-800'>SDG Related Data</h1>
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
                <table className="w-full text-sm text-left text-gray-700">
                    ...
                    <tbody>
                        {Array.isArray(impactData) && impactData.filter(el => el?.impactDataType === "SDGS").length > 0 ? (
                            impactData
                                .filter(el => el?.impactDataType === "SDGS")
                                .map(el => (
