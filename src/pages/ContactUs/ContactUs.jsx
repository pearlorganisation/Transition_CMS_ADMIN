...
import { deleteContact, getContactData, postContactData, updateContact } from "../../features/actions/contactAction";

export default function ContactUs() {
    const { isLoading, contactsData, postResponse, deleteResponse, updateResponse } = useSelector((state) => state.contacts);
                    ...
                    <div className="bg-white p-6 rounded shadow-md overflow-scroll h-[90vh]">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="space-x-3">
                                <button
                                    type="button"
                                    onClick={() => append({ title: "", type: "FORM", value: "", buttonText: "" })}
