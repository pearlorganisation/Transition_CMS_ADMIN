        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              {...register("title", { required: "Title is required" })}
              className="w-full px-3 py-2 border rounded-md dark:bg-gray-700 dark:text-white focus:ring-blue-500 focus:outline-none"
            />
            {errors.title && (
          ...
          <button
            type="submit"
            className="w-full py-3 text-lg font-medium bg-blue-600 hover:bg-blue-700 text-white rounded-md transition"
          >
            Add Press Data
          </button>
        </form>
